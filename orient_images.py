...
#load the labelnames from HDF5 dataset
...
for imagePath in imagePaths:
    ...
    #load the input image using Keras util function and make sure to resize the 
    #image to (224, 224)
    ...
    #pass the CNN features thorugh Logistic Regression classififer to obatin the 
